...
class PremiumWashActivity : AppCompatActivity() {
    var hargaKaos = 9000
    var hargaCelana = 8000
    var hargaJaket = 10000
    var hargaSprei = 70000
    var hargaKarpet = 250000
    var itemCount1 = 0
    var itemCount2 = 0
    var itemCount3 = 0
    var itemCount4 = 0
    ...
    private fun setInitLayout() {
        ...
        tvJumlahBarang?.run { setText("0 items") }
        tvTotalPrice?.run { setText("Rp 0") }
        tvInfo?.run { setText("Premium Wash menawarkan treatment eksklusif, menggunakan chemical yang environment friendly dan service sepenuh hati.") }
    }
