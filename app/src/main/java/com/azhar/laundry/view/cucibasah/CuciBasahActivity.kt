...
class CuciBasahActivity : AppCompatActivity() {
    var hargaKaos = 7000
    var hargaCelana = 5000
    var hargaJaket = 8000
    var hargaSprei = 55000
    var hargaKarpet = 150000
    var itemCount1 = 0
    var itemCount2 = 0
    var itemCount3 = 0
    var itemCount4 = 0
    ...
    private fun setInitLayout() {
        ...
        tvInfo?.run { setText("Cuci basah merupakan proses pencucian pakaian biasa menggunakan air dan deterjen.") }
    }
